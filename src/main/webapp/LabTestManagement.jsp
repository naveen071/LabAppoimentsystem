...
%>
				  ...
				  <td><%=resultSet.getString("testDescri") %></td>
				   ...
				   <td><a href="LabTestUpdate.jsp?lab_ID=<%=resultSet.getInt("lab_ID") %>"><button class="button1" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="fas fa-trash-alt"></span></button></p></a></td>
				 
				  <td><a href="LabTestDelete.jsp?lab_ID=<%=resultSet.getInt("lab_ID") %>"><button class="button2" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="fas fa-trash-alt"></span></button></p></a></td>
